...
const Section3MyPhilosophy = () => {
  return (
    <section className="max-w-[90rem] flex flex-col sm:flex-row justify-center items-center py-20 px-16 sm:px-32">
        ...
        <p className='text-[#64008C] font-black text-2xl sm:text-4xl text-center sm:text-left pb-4'>Prêt à changer le monde ensemble ?</p>
