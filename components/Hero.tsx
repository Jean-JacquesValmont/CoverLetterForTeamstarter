...
const Hero = () => {
  return (
    <div className="bg-[url('https://cdn.prod.website-files.com/621defa0940f1fecd5d8d53b/622b6b8e2118bede8a80ff19_confeti-bg.svg')] flex flex-col justify-center items-center pt-20 px-32">
        ...
        <p className='w-[87rem] pt-12 text-center text-3xl font-black text-neutral-800'>
           Actuellement, je suis à la recherche d&apos;une alternance de 12 mois (4 jours par semaine en entreprise) à partir de septembre 2024.
        </p>
    </div>
  )
}
